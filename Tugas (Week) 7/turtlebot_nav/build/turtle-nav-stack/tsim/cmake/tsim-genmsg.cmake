...
set(MSG_I_FLAGS "-Itsim:/home/nazrin/turtlebot_nav/src/turtle-nav-stack/tsim/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nazrin/turtlebot_nav/src/turtle-nav-stack/tsim/msg/PoseError.msg" NAME_WE)
add_custom_target(_tsim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tsim" "/home/nazrin/turtlebot_nav/src/turtle-nav-stack/tsim/msg/PoseError.msg" ""
)
...
_generate_msg_cpp(tsim
  "/home/nazrin/turtlebot_nav/src/turtle-nav-stack/tsim/msg/PoseError.msg"
  "${MSG_I_FLAGS}"
  ""
